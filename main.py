...
if args.ood_finetune:
    ...
    if args.model_name == 'ABCORV':
        model = models.ABCORV(mlp_q_dims, mlp_p1_dims, mlp_p2_dims, mlp_p3_dims, \
                                                item_feature, adj, E1_size, args.dropout, args.bn, args.sample_freq, args.regs, args.act_function).to(device)
    elif args.model_name == 'ABCORM':
        model = models.ABCORM(mlp_q_dims, mlp_p1_dims, mlp_p2_dims, mlp_p3_dims, \
                                                item_feature, adj, E1_size, args.dropout, args.bn, args.sample_freq, args.regs, args.act_function).to(device)
